...
const ChangeInfo = ({ loadCurrentUser, currentUser, setCloseModal, isUser = false }) => {
    ...
    const onFinish = async (value) => {
        ...
        let imageUrl;
        if (imageFile) {
            imageUrl = await FirebaseUtil.uploadFile("user", imageFile)
    ...
    return (
        <Form form={form} onFinish={onFinish} layout="vertical">
            ...
            <Form.Item label="Số điện thoại" name={"phone"} rules={[{ required: true, message: "Vui lòng nhập số điện thoại" }]}>
                <Input placeholder='Số điện thoại' readOnly={currentUser.provider === ''} />
            </Form.Item>
